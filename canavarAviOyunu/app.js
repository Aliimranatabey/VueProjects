new Vue({
    ...
    data:{
        ...
        log_text:{
            attack : "OYUNCU ATAĞI :",
            speccial_attack : "ÖZEL OYUNCU ATAĞI :",
    ...
    methods:{
        ...
        special_attack:function(){
            ...
            this.monster_heal-=point;
            this.add_to_log({turn : "p" , text : this.log_text.speccial_attack+point})
            this.monster_attack();
        },
        heal_up:function(){
    ...
    /* Bir değişkenin değerini okuyup ona göre hareket etmemizi sağlayan watch bloğunu kullanmamız gerekiyore */
    watch:{
